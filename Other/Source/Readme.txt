...
user in an INI file next to DrawioPortable.exe called DrawioPortable.ini.
...
copy AppNamePortable.ini from this directory to DrawioPortable.ini next to
DrawioPortable.exe. The options in the INI file are as follows:
